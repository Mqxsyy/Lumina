...
export default function VolumetricParticleShapeField({ NodeField, Label }: Props) {
    ...
    const enableDropdown = () => {
        ...
        EnableDropdown(posUDim2, elementRef.current.AbsoluteSize.X, [
            <HighlightableTextButton
                ...
                Text="Cube"
                OnClick={() => {
                    NodeField.SetShape(VolumetricParticleShapes.Cube);
                }}
            />,
            <HighlightableTextButton
                key={1}
                ...
                Text="Sphere"
                OnClick={() => {
                    NodeField.SetShape(VolumetricParticleShapes.Sphere);
                }}
            />,
        ]);
    };
